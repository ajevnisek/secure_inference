...
def load_choosing_matrices():
    import pickle
    with open("temp_dir/replace_ten_and_then_the_rest/associations/layer_name_to_choosing_matrix/layer_name_to_matrix.pkl", 'rb') as f:
...
log_level = 'INFO'
load_from = None
resume_from = 'temp_dir/replace_ten_and_then_the_rest/checkpoints/checkpoint_0.pth'
