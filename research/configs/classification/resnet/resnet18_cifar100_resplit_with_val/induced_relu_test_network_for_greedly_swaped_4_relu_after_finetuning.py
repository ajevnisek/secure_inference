...
removed_sequence =['layer4[1].relu_2',
 'layer1[0].relu_1',
 'layer1[1].relu_2',
 'layer2[0].relu_2',
 'layer1[1].relu_1',
...
resume_from = f'trained_networks/classification/resnet18_cifar100_resplit' \
              f'/induced_relu_backbone_greedly_swap_{NUM_OF_REPLACEMENTS}_relus_finetune/latest.pth'
checkpoint = f'trained_networks/classification/resnet18_cifar100_resplit' \
              f'/induced_relu_backbone_greedly_swap_{NUM_OF_REPLACEMENTS}_relus_finetune/latest.pth'
