...
USE_INDUCED_RELU[1][1] = True

DEFAULT_PICLE_PATH = osp.join('cached_relus/cifar100_with_val/resnet18/'
...
resume_from = 'osi_checkpoints/cifar100/resnet18/replaced_4_relus_greedy/' \
              'greedy_search_for_four_induced_relus.pth'
# checkpoint = 'osi_checkpoints/cifar100/resnet18/replaced_4_relus_greedy' \
#     '/greedy_search_for_four_induced_relus.pth'
