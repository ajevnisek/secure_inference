...
DEFAULT_PICLE_PATH = 'cached_relus/cifar100_with_val/resnet18/100_most_important_relus/layer_name_to_choosing_matrix/layer_name_to_matrix.pkl'
...
log_level = "INFO"
load_from = None
resume_from = os.path.join("osi_checkpoints/cifar100/resnet18_cifar100_resplit_with_val_100_prototypes",
