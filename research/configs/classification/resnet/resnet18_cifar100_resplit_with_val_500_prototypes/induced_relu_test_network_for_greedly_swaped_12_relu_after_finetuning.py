...
DEFAULT_PICLE_PATH = "cached_relus/cifar100_with_val/resnet18/500_most_important_relus/layer_name_to_choosing_matrix/layer_name_to_matrix.pkl"
...
resume_from = osp.join("trained_networks/classification/resnet18_cifar100_resplit_with_val_500_prototypes", 
     f"/induced_relu_backbone_greedly_swap_{NUM_OF_REPLACEMENTS}_relus_finetune/latest.pth") 
checkpoint = osp.join("trained_networks/classification/resnet18_cifar100_resplit_with_val_500_prototypes", 
     f"/induced_relu_backbone_greedly_swap_{NUM_OF_REPLACEMENTS}_relus_finetune/latest.pth") 
