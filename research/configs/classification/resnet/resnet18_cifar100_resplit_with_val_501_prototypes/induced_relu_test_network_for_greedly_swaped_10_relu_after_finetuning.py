...
resume_from = osp.join("trained_networks/classification/resnet18_cifar100_resplit_with_val_501_prototypes", 
     f"/induced_relu_backbone_greedly_swap_{NUM_OF_REPLACEMENTS}_relus_finetune/latest.pth") 
checkpoint = osp.join("trained_networks/classification/resnet18_cifar100_resplit_with_val_501_prototypes", 
     f"/induced_relu_backbone_greedly_swap_{NUM_OF_REPLACEMENTS}_relus_finetune/latest.pth") 
