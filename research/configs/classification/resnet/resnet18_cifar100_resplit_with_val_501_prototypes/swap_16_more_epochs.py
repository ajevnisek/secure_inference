...
lr_config = dict(policy="step", step=[60, 120, 160, 260], gamma=0.2)
...
log_level = "INFO"
load_from = None
resume_from = os.path.join("osi_checkpoints/cifar100/resnet18_cifar100_resplit_with_val_501_prototypes",
