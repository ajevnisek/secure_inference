...
export INDUCER_TO_INDUCED_MAPPING=flattened_resnet18_half.json
...
export PROTOTYPES_COUNTS="1000 1000"
...
export NEW_INDUCED_MODEL_NAME=ResNet18Halfway

# The file name (NOT path) of the induced model definition that will be added to mmcls.
export NEW_INDUCED_MODEL_CONFIG_FILE_NAME=resnet18_halfway.py
...
export FINETUNE_INDUCED_MODEL_CONFIG_FILE=research/configs/classification/flattened_resnet/halfway_finetune_resplit_cifar100_dataset.py

# The path to the directory to which all finetuning artifacts will be written. This directory MUST exist.
export FINETUNE_WORK_DIR=trained_networks/classification/resnet18_cifar100_resplit_flattened_backbone/halfway_finetune/
