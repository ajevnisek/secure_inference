...
def parse_args():
    ...
    parser.add_argument('num_prototypes', type=int, help='number of prototypes for clustering')
...
def cluster_relus_in_first_layer(args):
    ...
    with open(osp.join(args.outdir, f'{num_prototypes}_prototypes_indices_p=0.pkl'),
              'wb') as f:
    ...
    with open(osp.join(args.outdir,
                       f'{num_prototypes}_prototypes_p=0.pkl'), 'wb') as f:
