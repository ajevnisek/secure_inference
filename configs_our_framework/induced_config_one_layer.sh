...
export INDUCER_TO_INDUCED_MAPPING=json_configs/flattened_resnet18_one_induced_layer.json
...
export NEW_INDUCED_MODEL_NAME=ResNet18OneLayerWithSelfInduce

# The file name (NOT path) of the induced model definition that will be added to mmcls. 
export NEW_INDUCED_MODEL_CONFIG_FILE_NAME=resnet18_one_layer_with_self_induce.py
...
export CACHE_DIR=cached_relus/cifar100_with_val/flattened_resnet18/one_layer_with_self_induce
...
export BASE_INDUCED_MODEL_CONFIG_FILE=research/configs/classification/flattened_resnet/one_layer_with_self_induce_nework_resplit_cifar100_dataset.py
...
export FINETUNE_INDUCED_MODEL_CONFIG_FILE=research/configs/classification/flattened_resnet/one_layer_with_self_induce_nework_with_self_induce_resplit_cifar100_dataset.py

# The path to the directory to which all finetuning artifacts will be written. This directory MUST exist.
export FINETUNE_WORK_DIR=trained_networks/classification/resnet18_cifar100_resplit_flattened_backbone/one_layer_with_self_induce_nework_with_self_induce/
