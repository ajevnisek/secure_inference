...
export INDUCER_TO_INDUCED_MAPPING=json_configs/flattened_resnet18_pairwise_induced_layer.json
...
export PROTOTYPES_COUNTS="10 10 10 10 10 10 10 10 10"
...
export NEW_INDUCED_MODEL_NAME=ResNet18PairwiseSelfInduce

# The file name (NOT path) of the induced model definition that will be added to mmcls. 
export NEW_INDUCED_MODEL_CONFIG_FILE_NAME=resnet18_pairwise_self_induce.py
